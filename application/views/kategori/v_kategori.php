            ...
            <div class="modal-content">
                ...
                <form action="#">
                    <div class="modal-body">
                        <label for="txnama">Kategori Barang</label>
                        <div class="form-group">
                            <input id="txkategori" type="text" class="form-control">
                        </div>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-warning btn-editen ms-1" onclick="update_kategori()">
                            <i class="bx bx-check d-block d-sm-none"></i>
...
<div class="card card-data">
    ...
    $breadcrumbs = array(
        'Home' => base_url(),
        'Manajemen kategori' => site_url('kategori')
    );
    ...
    <div class="card-header">
        ...
        <div class=" card-body information">
            <div class="alert alert-success" role="alert">Kategori Berhasil Ditambahkan</div>
        </div>
    </div>
    <div class="card-body">
